...
export function PersonalizationSection() {
  return (
    <section className="personal" aria-labelledby="personal-title">
      <div className="portal-container personal__inner">
        <div className="personal__intro">
          <span className="personal__badge"><UserRound size={14} /> 로그인 회원 서비스</span>
        ...
        <div className="personal__grid">
          {personalizationItems.map((item) => {
            ...
            return (
              <article className="personal__card" key={item.title}>
                <span className="personal__icon"><Icon size={19} strokeWidth={1.8} /></span>
                <h3>{item.title}</h3>
